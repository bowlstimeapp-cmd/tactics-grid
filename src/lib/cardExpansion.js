...
export const EXPANSION_CARDS = [
  // ── KNIGHTS (13) ──
  { card_id:"C101",name:"Page Boy",faction:"Knights",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"He carries the shield until he can wield the sword." },
  { card_id:"C102",name:"Conscript",faction:"Knights",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Drafted at dawn, drilled by dusk." },
  { card_id:"C103",name:"Militia",faction:"Knights",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Farmhands with pitchforks, standing tall." },
  { card_id:"C104",name:"Foot Soldier",faction:"Knights",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"The backbone of every army." },
  { card_id:"C105",name:"Man-at-Arms",faction:"Knights",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Trained, armoured, and ready." },
  { card_id:"C106",name:"Herald",faction:"Knights",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"His trumpet calls the charge." },
  ...
  // ── DRAGONS (12) ──
  { card_id:"C114",name:"Spark Drake",faction:"Dragons",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Static crackles along its spine." },
  { card_id:"C115",name:"Young Wyrm",faction:"Dragons",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Its scales have not yet hardened." },
  { card_id:"C116",name:"Cave Lizard",faction:"Dragons",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A distant cousin of the great wyrms." },
  { card_id:"C117",name:"Wind Serpent",faction:"Dragons",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"It rides the thermals effortlessly." },
  { card_id:"C118",name:"Bronze Drake",faction:"Dragons",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Its scales gleam like polished metal." },
  { card_id:"C119",name:"Cliff Glider",faction:"Dragons",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"It nests where no predator can reach." },
  { card_id:"C120",name:"Coral Snake",faction:"Dragons",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Beautiful, but deadly." },
  ...
  // ── BEASTS (13) ──
  { card_id:"C126",name:"Field Mouse",faction:"Beasts",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Small but nimble, quick to flee." },
  { card_id:"C127",name:"Wild Dog",faction:"Beasts",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"It scavenges at the edges of battle." },
  { card_id:"C128",name:"Mountain Goat",faction:"Beasts",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Sure-footed on the steepest cliffs." },
  { card_id:"C129",name:"River Otter",faction:"Beasts",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Playful, but surprisingly fierce." },
  { card_id:"C130",name:"Stag",faction:"Beasts",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Its antlers gleam in the moonlight." },
  { card_id:"C131",name:"Warthog",faction:"Beasts",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Charges first, asks questions never." },
  { card_id:"C132",name:"Lynx",faction:"Beasts",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Silent, patient, and lethal." },
  { card_id:"C133",name:"Dire Wolf",faction:"Beasts",north:5,east:5,south:4,west:4,passive_id:"beast_synergy",flavour_text:"The alpha of a feral pack." },
  ...
  // ── MAGES (12) ──
  { card_id:"C139",name:"Novice",faction:"Mages",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"She has memorized the first page." },
  { card_id:"C140",name:"Herb Witch",faction:"Mages",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Her potions heal and harm in equal measure." },
  { card_id:"C141",name:"Scroll Bearer",faction:"Mages",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"He carries knowledge he cannot yet use." },
  { card_id:"C142",name:"Rune Scribe",faction:"Mages",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Every rune tells a story of power." },
  { card_id:"C143",name:"Hedge Mage",faction:"Mages",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Self-taught, surprisingly effective." },
  { card_id:"C144",name:"Diviner",faction:"Mages",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"She sees what others cannot." },
  ...
  // ── MACHINES (13) ──
  { card_id:"C151",name:"Scrap Bot",faction:"Machines",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Built from discarded parts, running on fumes." },
  { card_id:"C152",name:"Tinker Toy",faction:"Machines",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A prototype that never quite worked." },
  { card_id:"C153",name:"Wind-up Soldier",faction:"Machines",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Turn the key and watch it march." },
  { card_id:"C154",name:"Clockwork Mouse",faction:"Machines",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Built to scout, not to fight." },
  { card_id:"C155",name:"Gear Knight",faction:"Machines",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Precision-engineered for battle." },
  { card_id:"C156",name:"Piston Walker",faction:"Machines",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Every step hisses with steam." },
  ...
  // ── SPIRITS (12) ──
  { card_id:"C164",name:"Mote",faction:"Spirits",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A speck of light in the void." },
  { card_id:"C165",name:"Tiny Spark",faction:"Spirits",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A fragment of a greater flame." },
  { card_id:"C166",name:"Dust Devil",faction:"Spirits",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A swirl of restless energy." },
  { card_id:"C167",name:"Whisper",faction:"Spirits",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A voice from beyond the veil." },
  { card_id:"C168",name:"Glow",faction:"Spirits",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"It illuminates the darkest corners." },
  { card_id:"C169",name:"Echo",faction:"Spirits",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"A sound that refuses to fade." },
  ...
  // ── ASSASSINS (13) ──
  { card_id:"C176",name:"Urchin",faction:"Assassins",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Small hands, quick fingers." },
  { card_id:"C177",name:"Cutpurse",faction:"Assassins",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A blade in the crowd." },
  { card_id:"C178",name:"Street Rat",faction:"Assassins",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Nobody notices him until it's too late." },
  { card_id:"C179",name:"Courier",faction:"Assassins",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"He knows every back alley." },
  { card_id:"C180",name:"Thug",faction:"Assassins",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Brute force disguised as subtlety." },
  { card_id:"C181",name:"Burglar",faction:"Assassins",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"In and out before the alarm sounds." },
  ...
  // ── UNDEAD (12) ──
  { card_id:"C189",name:"Bone Shard",faction:"Undead",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"A fragment of something greater." },
  { card_id:"C190",name:"Husk",faction:"Undead",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Empty, but still moving." },
  { card_id:"C191",name:"Rotting Corpse",faction:"Undead",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"It shambles forward relentlessly." },
  { card_id:"C192",name:"Skeletal Archer",faction:"Undead",north:4,east:4,south:4,west:3,rarity:"Common",passive_id:"none",flavour_text:"Death has not dulled its aim." },
  { card_id:"C193",name:"Ghoul",faction:"Undead",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"Hunger drives it forward." },
  { card_id:"C194",name:"Crypt Stalker",faction:"Undead",north:4,east:4,south:4,west:4,passive_id:"none",flavour_text:"It knows every tunnel beneath the earth." },
